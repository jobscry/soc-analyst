...
def test_token_on_post_notfound(client, superuser):
...
def test_token_on_post_is_admin(client, superuser):
    resp = client.simulate_post(
...
def test_token_on_post_is_not_admin_bad(client, superuser):
...
def test_token_on_post_is_not_admin_ok(client, superuser):
    u = create_user("test-user", "test-user")
    resp = client.simulate_post(
